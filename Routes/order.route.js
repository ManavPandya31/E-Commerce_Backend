...
verifyCoupon , getProviderOwnOrders , getProviderDashboardStats , verifyPayment} from "../controllers/order.controller.js";
import { verifyJwtToken } from "../middlewares/auth.middleware.js";

const orderrouter = Router();

orderrouter.route("/createOrder").post(verifyJwtToken, createOrder);
orderrouter.route("/verifyPayment").post(verifyJwtToken, verifyPayment);
